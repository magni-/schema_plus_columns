...
* ruby **2.3.8** with activerecord **5.0**, using **mysql2**, **postgresql** or **sqlite3**
* ruby **2.3.8** with activerecord **5.1**, using **mysql2**, **postgresql** or **sqlite3**
* ruby **2.3.8** with activerecord **5.2**, using **mysql2**, **postgresql** or **sqlite3**
* ruby **2.3.8** with activerecord **6.0**, using **mysql2**, **postgresql** or **sqlite3**
* ruby **2.4.9** with activerecord **5.0**, using **mysql2**, **postgresql** or **sqlite3**
* ruby **2.4.9** with activerecord **5.1**, using **mysql2**, **postgresql** or **sqlite3**
* ruby **2.4.9** with activerecord **5.2**, using **mysql2**, **postgresql** or **sqlite3**
* ruby **2.4.9** with activerecord **6.0**, using **mysql2**, **postgresql** or **sqlite3**
* ruby **2.5.7** with activerecord **5.0**, using **mysql2**, **postgresql** or **sqlite3**
* ruby **2.5.7** with activerecord **5.1**, using **mysql2**, **postgresql** or **sqlite3**
* ruby **2.5.7** with activerecord **5.2**, using **mysql2**, **postgresql** or **sqlite3**
* ruby **2.5.7** with activerecord **6.0**, using **mysql2**, **postgresql** or **sqlite3**
* ruby **2.6.5** with activerecord **5.0**, using **mysql2**, **postgresql** or **sqlite3**
* ruby **2.6.5** with activerecord **5.1**, using **mysql2**, **postgresql** or **sqlite3**
* ruby **2.6.5** with activerecord **5.2**, using **mysql2**, **postgresql** or **sqlite3**
* ruby **2.6.5** with activerecord **6.0**, using **mysql2**, **postgresql** or **sqlite3**
